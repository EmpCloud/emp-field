                    ...
                    <div style="max-width:600px;margin:0 auto;font-family: 'Poppins', sans-serif;padding:0;box-shadow: 0px 7px 51px -29px #2b478b;background-image: url('https://empmonitor.com/wp-content/uploads/2022/12/600x700.png');background-repeat: no-repeat;
                        ...
                        <table style="width:100%;border-spacing: 0px;text-align: center;">
                            <tbody>
                                ...
                                <tr>
                                    <td style="padding: 0 11px;">
                                        <a href="${config.get('sendgrid.user_mail_verify_link')}=${userData?.emailValidateToken}&userMail=${userData?.email}
                    ...
                    <tr>
                        <td>
                            ...
                            ">
                                ...
                                <p style="text-align: left; font-size: 1rem;">Hello ${data?.fullName},</p>
                                <p style="text-align: justify; font-size: 1rem;">We are thrilled to welcome you to ${config.get('productName')}, your all-in-one solution for efficient and effective FieldForce management. This groundbreaking new application will provide you with peace of mind regarding work compatibility by offering flexible options to maintain focus and stay updated on your work.</p>
    
                                <p style="text-align: left; font-size: 1rem;">To get started, simply log in using your credentials.</p>
                                ...
                                <div>
                                    ...
                                    margin: auto;">
                                       <tbody style="background: #f4f7ff;">
                                           ...
                                           <tr>
                                           <td style="  border: 1px solid #ccc;
                                           border-collapse: collapse; padding: 10px;"><p style="font-size: 14px; font-weight: 600; color: #3876fb;">Phone Number</p></td>
                                           <td style="  border: 1px solid #ccc;
                                           border-collapse: collapse; padding: 10px;"><p style="    color: #171717; font-size: 14px;">${data?.phoneNumber}</p></td>
                                       </tr>
                                       </tbody>
...
// export let WelComeMail =async userData => {
//     sendGridMail.setApiKey(config.get('sendgrid.key'));
//     let bulkEmail = [];
//     const mailPromise = userData.map(data => {
//         let email = {
//             from: {
...
//             },
//             to: data?.email,
//             subject: `Field Force Management`,
                    ...
                    <tr>
                        <td>
                            ...
                            ">
                                ...
                                <p style="text-align: left; font-size: 1rem;">Hello ${userData?.fullName},</p>
                                ...
                                <p style="text-align: left; font-size: 1rem;"><span style="font-weight: 600;">Please enter below secret key to rest the password.</p>
    
                                <p style="display: inline-block; text-align: left;"> 
                                ${userData?.forgotPasswordToken}
                                </p>
