...
public final class HomeViewModel_Factory implements Factory<HomeViewModel> {
  ...
  public HomeViewModel_Factory(Provider<NetworkRepository> repositoryProvider) {
  ...
  public static HomeViewModel_Factory create(Provider<NetworkRepository> repositoryProvider) {
    return new HomeViewModel_Factory(repositoryProvider);
  }

  public static HomeViewModel newInstance(NetworkRepository repository) {
