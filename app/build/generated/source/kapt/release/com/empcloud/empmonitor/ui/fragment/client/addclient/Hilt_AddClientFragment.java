...
public abstract class Hilt_AddClientFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddClientFragment() {
    super();
  }

  Hilt_AddClientFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddClientFragment_GeneratedInjector) this.generatedComponent()).injectAddClientFragment(UnsafeCasts.<AddClientFragment>unsafeCast(this));
    }
  }
