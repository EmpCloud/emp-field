...
public abstract class Hilt_UpdateAddressFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UpdateAddressFragment() {
    super();
  }

  Hilt_UpdateAddressFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpdateAddressFragment_GeneratedInjector) this.generatedComponent()).injectUpdateAddressFragment(UnsafeCasts.<UpdateAddressFragment>unsafeCast(this));
    }
  }
