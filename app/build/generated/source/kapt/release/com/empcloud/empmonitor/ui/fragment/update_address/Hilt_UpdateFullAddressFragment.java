...
public abstract class Hilt_UpdateFullAddressFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UpdateFullAddressFragment() {
    super();
  }

  Hilt_UpdateFullAddressFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpdateFullAddressFragment_GeneratedInjector) this.generatedComponent()).injectUpdateFullAddressFragment(UnsafeCasts.<UpdateFullAddressFragment>unsafeCast(this));
    }
  }
