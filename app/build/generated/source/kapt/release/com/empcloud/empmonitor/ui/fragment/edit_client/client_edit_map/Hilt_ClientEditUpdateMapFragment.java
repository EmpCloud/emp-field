...
public abstract class Hilt_ClientEditUpdateMapFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClientEditUpdateMapFragment() {
    super();
  }

  Hilt_ClientEditUpdateMapFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientEditUpdateMapFragment_GeneratedInjector) this.generatedComponent()).injectClientEditUpdateMapFragment(UnsafeCasts.<ClientEditUpdateMapFragment>unsafeCast(this));
    }
  }
