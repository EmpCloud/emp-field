...
public abstract class Hilt_MapCurrentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MapCurrentFragment() {
    super();
  }

  Hilt_MapCurrentFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MapCurrentFragment_GeneratedInjector) this.generatedComponent()).injectMapCurrentFragment(UnsafeCasts.<MapCurrentFragment>unsafeCast(this));
    }
  }
