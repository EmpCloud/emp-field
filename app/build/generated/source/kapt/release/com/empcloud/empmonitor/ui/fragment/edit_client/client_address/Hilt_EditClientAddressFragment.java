...
public abstract class Hilt_EditClientAddressFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditClientAddressFragment() {
    super();
  }

  Hilt_EditClientAddressFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditClientAddressFragment_GeneratedInjector) this.generatedComponent()).injectEditClientAddressFragment(UnsafeCasts.<EditClientAddressFragment>unsafeCast(this));
    }
  }
