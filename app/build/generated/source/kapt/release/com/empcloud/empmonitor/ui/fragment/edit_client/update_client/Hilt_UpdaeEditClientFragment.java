...
public abstract class Hilt_UpdaeEditClientFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UpdaeEditClientFragment() {
    super();
  }

  Hilt_UpdaeEditClientFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpdaeEditClientFragment_GeneratedInjector) this.generatedComponent()).injectUpdaeEditClientFragment(UnsafeCasts.<UpdaeEditClientFragment>unsafeCast(this));
    }
  }
