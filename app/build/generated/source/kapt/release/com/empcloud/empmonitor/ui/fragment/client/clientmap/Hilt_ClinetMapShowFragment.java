...
public abstract class Hilt_ClinetMapShowFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClinetMapShowFragment() {
    super();
  }

  Hilt_ClinetMapShowFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClinetMapShowFragment_GeneratedInjector) this.generatedComponent()).injectClinetMapShowFragment(UnsafeCasts.<ClinetMapShowFragment>unsafeCast(this));
    }
  }
