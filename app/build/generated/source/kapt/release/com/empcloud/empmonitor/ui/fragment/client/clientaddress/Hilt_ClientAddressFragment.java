...
public abstract class Hilt_ClientAddressFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClientAddressFragment() {
    super();
  }

  Hilt_ClientAddressFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientAddressFragment_GeneratedInjector) this.generatedComponent()).injectClientAddressFragment(UnsafeCasts.<ClientAddressFragment>unsafeCast(this));
    }
  }
