...
public abstract class Hilt_AutoCheckoutReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((AutoCheckoutReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectAutoCheckoutReceiver(UnsafeCasts.<AutoCheckoutReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
