...
public abstract class Hilt_UpdateProfileFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UpdateProfileFragment() {
    super();
  }

  Hilt_UpdateProfileFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpdateProfileFragment_GeneratedInjector) this.generatedComponent()).injectUpdateProfileFragment(UnsafeCasts.<UpdateProfileFragment>unsafeCast(this));
    }
  }
