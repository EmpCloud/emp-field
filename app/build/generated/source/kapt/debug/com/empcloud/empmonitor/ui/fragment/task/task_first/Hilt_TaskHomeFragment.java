...
public abstract class Hilt_TaskHomeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TaskHomeFragment() {
    super();
  }

  Hilt_TaskHomeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TaskHomeFragment_GeneratedInjector) this.generatedComponent()).injectTaskHomeFragment(UnsafeCasts.<TaskHomeFragment>unsafeCast(this));
    }
  }
