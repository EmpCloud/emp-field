...
public abstract class Hilt_ClientHomeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClientHomeFragment() {
    super();
  }

  Hilt_ClientHomeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientHomeFragment_GeneratedInjector) this.generatedComponent()).injectClientHomeFragment(UnsafeCasts.<ClientHomeFragment>unsafeCast(this));
    }
  }
