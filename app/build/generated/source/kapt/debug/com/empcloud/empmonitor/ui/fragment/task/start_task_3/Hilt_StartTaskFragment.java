...
public abstract class Hilt_StartTaskFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StartTaskFragment() {
    super();
  }

  Hilt_StartTaskFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StartTaskFragment_GeneratedInjector) this.generatedComponent()).injectStartTaskFragment(UnsafeCasts.<StartTaskFragment>unsafeCast(this));
    }
  }
