...
public abstract class Hilt_ClientDirectionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClientDirectionFragment() {
    super();
  }

  Hilt_ClientDirectionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientDirectionFragment_GeneratedInjector) this.generatedComponent()).injectClientDirectionFragment(UnsafeCasts.<ClientDirectionFragment>unsafeCast(this));
    }
  }
