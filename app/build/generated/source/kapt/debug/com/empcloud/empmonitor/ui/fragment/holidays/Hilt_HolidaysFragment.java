...
public abstract class Hilt_HolidaysFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_HolidaysFragment() {
    super();
  }

  Hilt_HolidaysFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((HolidaysFragment_GeneratedInjector) this.generatedComponent()).injectHolidaysFragment(UnsafeCasts.<HolidaysFragment>unsafeCast(this));
    }
  }
