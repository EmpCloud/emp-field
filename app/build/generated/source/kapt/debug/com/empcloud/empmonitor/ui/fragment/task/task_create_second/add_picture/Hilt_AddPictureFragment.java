...
public abstract class Hilt_AddPictureFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddPictureFragment() {
    super();
  }

  Hilt_AddPictureFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddPictureFragment_GeneratedInjector) this.generatedComponent()).injectAddPictureFragment(UnsafeCasts.<AddPictureFragment>unsafeCast(this));
    }
  }
