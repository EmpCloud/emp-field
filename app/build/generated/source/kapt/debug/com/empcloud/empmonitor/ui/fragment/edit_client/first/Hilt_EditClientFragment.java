...
public abstract class Hilt_EditClientFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EditClientFragment() {
    super();
  }

  Hilt_EditClientFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EditClientFragment_GeneratedInjector) this.generatedComponent()).injectEditClientFragment(UnsafeCasts.<EditClientFragment>unsafeCast(this));
    }
  }
