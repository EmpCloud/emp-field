...
public abstract class Hilt_StartTaskPicFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_StartTaskPicFragment() {
    super();
  }

  Hilt_StartTaskPicFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StartTaskPicFragment_GeneratedInjector) this.generatedComponent()).injectStartTaskPicFragment(UnsafeCasts.<StartTaskPicFragment>unsafeCast(this));
    }
  }
