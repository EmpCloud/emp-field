...
public abstract class Hilt_UpdateAddressMapFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_UpdateAddressMapFragment() {
    super();
  }

  Hilt_UpdateAddressMapFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UpdateAddressMapFragment_GeneratedInjector) this.generatedComponent()).injectUpdateAddressMapFragment(UnsafeCasts.<UpdateAddressMapFragment>unsafeCast(this));
    }
  }
