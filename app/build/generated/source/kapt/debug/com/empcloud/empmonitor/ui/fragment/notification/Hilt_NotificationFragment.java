...
public abstract class Hilt_NotificationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NotificationFragment() {
    super();
  }

  Hilt_NotificationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotificationFragment_GeneratedInjector) this.generatedComponent()).injectNotificationFragment(UnsafeCasts.<NotificationFragment>unsafeCast(this));
    }
  }
