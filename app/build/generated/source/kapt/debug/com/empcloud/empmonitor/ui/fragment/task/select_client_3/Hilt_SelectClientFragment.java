...
public abstract class Hilt_SelectClientFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SelectClientFragment() {
    super();
  }

  Hilt_SelectClientFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SelectClientFragment_GeneratedInjector) this.generatedComponent()).injectSelectClientFragment(UnsafeCasts.<SelectClientFragment>unsafeCast(this));
    }
  }
