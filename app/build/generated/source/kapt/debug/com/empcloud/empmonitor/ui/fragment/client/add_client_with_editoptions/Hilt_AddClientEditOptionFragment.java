...
public abstract class Hilt_AddClientEditOptionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddClientEditOptionFragment() {
    super();
  }

  Hilt_AddClientEditOptionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddClientEditOptionFragment_GeneratedInjector) this.generatedComponent()).injectAddClientEditOptionFragment(UnsafeCasts.<AddClientEditOptionFragment>unsafeCast(this));
    }
  }
