...
public abstract class Hilt_ClientAddFinalFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClientAddFinalFragment() {
    super();
  }

  Hilt_ClientAddFinalFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientAddFinalFragment_GeneratedInjector) this.generatedComponent()).injectClientAddFinalFragment(UnsafeCasts.<ClientAddFinalFragment>unsafeCast(this));
    }
  }
