...
public abstract class Hilt_ClientCompleteAddressFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClientCompleteAddressFragment() {
    super();
  }

  Hilt_ClientCompleteAddressFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClientCompleteAddressFragment_GeneratedInjector) this.generatedComponent()).injectClientCompleteAddressFragment(UnsafeCasts.<ClientCompleteAddressFragment>unsafeCast(this));
    }
  }
