...
public abstract class Hilt_LeavesFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LeavesFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LeavesFragment_GeneratedInjector) this.generatedComponent()).injectLeavesFragment(UnsafeCasts.<LeavesFragment>unsafeCast(this));
    }
  }
