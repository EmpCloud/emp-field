...
public final class SplashScreenBinding implements ViewBinding {
  ...
  private SplashScreenBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView) {
  ...
  public static SplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SplashScreenBinding((ConstraintLayout) rootView, imageView);
    }
