...
public final class ActivityTutorialBinding implements ViewBinding {
  ...
  private ActivityTutorialBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout layoutDots, @NonNull ConstraintLayout main,
      @NonNull ViewPager slidesPager) {
  ...
  public static ActivityTutorialBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.slidesPager;
      ViewPager slidesPager = ViewBindings.findChildViewById(rootView, id);
      if (slidesPager == null) {
        break missingId;
      }

      return new ActivityTutorialBinding((ConstraintLayout) rootView, layoutDots, main,
          slidesPager);
    }
